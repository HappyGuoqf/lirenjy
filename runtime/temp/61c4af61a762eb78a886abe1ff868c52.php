<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/www/web/lirenjy/public_html/app/user/view/index/contract_content_list.html";i:1524227025;s:64:"/www/web/lirenjy/public_html/app/user/view/common/loginHead.html";i:1524724888;s:61:"/www/web/lirenjy/public_html/app/user/view/common/footer.html";i:1523437223;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="weixin-bg">
        ...
        <div class="weui-panel">
            ...
            <a href="<?php echo url('user/index/contract_content',array('id'=>$vo['id'])); ?>">
                <div class="weui-media-box weui-media-box_text">
                    <h4 class="weui-media-box__title"><?php echo $vo['university']; ?></h4>
                    <ul class="weui-media-box__info">
                        <li class="weui-media-box__desc">日期：<?php echo toDate($vo['addtime'],'Y-m-d'); ?>&nbsp;&nbsp;编号：<?php echo $vo['signature_num']; ?></li>
                    </ul>
                </div>
                </a>
            </div>
