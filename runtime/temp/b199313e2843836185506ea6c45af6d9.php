<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"/www/web/lirenjy/public_html/app/user/view/index/enregister_pic.html";i:1525229161;s:64:"/www/web/lirenjy/public_html/app/user/view/common/loginHead.html";i:1524724888;s:61:"/www/web/lirenjy/public_html/app/user/view/common/footer.html";i:1523437223;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<?php if($info['enregister_state'] == 1): ?>
<div class="photos_info">
    <img src="/<?php echo $info['enregister_pic']; ?>" />
    <span>(<?php echo $info['enregister_state_title']; ?>)</span>
</div>
<?php elseif($info['enregister_state'] == 2): ?>
<div class="photos_info">
    <img src="/<?php echo $info['enregister_pic']; ?>" />
    <span>(<?php echo $info['enregister_state_title']; ?>)</span>
</div>
<?php elseif($info['enregister_state'] == 3): ?>
    <div class="photos_info">
        <img src="/<?php echo $info['enregister_pic']; ?>" />
        <span>(<?php echo $info['enregister_state_title']; ?>)</span>
    </div>
                   ...
                   //console.log(base64);
                    ...
                    //console.log(img.src);
                         $.ajax({
                                    ...
                                    url: "<?php echo url('index/enregister_pic'); ?>",
