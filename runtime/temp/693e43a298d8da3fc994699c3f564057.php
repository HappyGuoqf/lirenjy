<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"/www/web/lirenjy/public_html/app/user/view/index/messages.html";i:1524188754;s:64:"/www/web/lirenjy/public_html/app/user/view/common/loginHead.html";i:1524724888;s:61:"/www/web/lirenjy/public_html/app/user/view/common/footer.html";i:1523437223;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="weui-panel">
            <div class="weui-panel__bd">
                <div class="weui-media-box weui-media-box_text">
                    ...
                    <p class="weui-media-box__desc" style="-webkit-line-clamp: 10;"><?php echo $vo['contant']; ?></p>
                    <ul class="weui-media-box__info">
                        <li class="weui-media-box__info__meta">立人教育</li>
                        <li class="weui-media-box__info__meta"><?php echo toDate($vo['addtime'],'Y-m-d'); ?></li>
