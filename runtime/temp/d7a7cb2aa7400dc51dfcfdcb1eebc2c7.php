<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"/www/web/lirenjy/public_html/app/user/view/index/signature_contract.html";i:1525079002;s:64:"/www/web/lirenjy/public_html/app/user/view/common/loginHead.html";i:1524724888;s:61:"/www/web/lirenjy/public_html/app/user/view/common/footer.html";i:1523437223;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<style type="text/css">
    ...
    .signature_tip{ padding-left:15px; }
...
<div class="signature_content">
	...
	<div class="signature_date">日期：<?php echo $list['addtime']; ?></div>
	<div class="signature_num">合同编号：<?php echo $list['signature_num']; ?></div>
</div>
<div class="weui-media-box__bd signature_tip">
        <p class="weui-media-box__desc">温馨提示：此合同可在会员中心查看！</p>
</div>
