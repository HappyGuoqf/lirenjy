<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"/www/web/lirenjy/public_html/app/user/view/index/work_pic.html";i:1525230025;s:64:"/www/web/lirenjy/public_html/app/user/view/common/loginHead.html";i:1524724888;s:61:"/www/web/lirenjy/public_html/app/user/view/common/footer.html";i:1523437223;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="photos_info">
    <img src="/<?php echo $info['work_pic']; ?>" />
    <span>(<?php echo $info['work_state_title']; ?>)</span>
</div>
                   ...
                   //console.log(base64);
                    ...
                    //console.log(img.src);
                         $.ajax({
                                    ...
                                    url: "<?php echo url('index/work_pic'); ?>",
