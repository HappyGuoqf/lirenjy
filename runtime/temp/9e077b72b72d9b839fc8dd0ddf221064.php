<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:57:"/www/web/lirenjy/public_html/app/user/view/index/pay.html";i:1524192006;s:64:"/www/web/lirenjy/public_html/app/user/view/common/loginHead.html";i:1524724888;s:61:"/www/web/lirenjy/public_html/app/user/view/common/footer.html";i:1523437223;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="weixin-bg">
        ...
        <div class="weui-panel">
            <div class="weui-panel__bd">
                <?php if($vo['f_money'] != null): ?>
                <div class="weui-media-box weui-media-box_text">
                    <h4 class="weui-media-box__title"><?php echo $vo['university']; ?></h4>
                    <ul class="weui-media-box__info">
                        <li class="weui-media-box__desc">总费用：<?php echo $vo['tuition']; ?>&nbsp;&nbsp;实收：<?php echo $vo['f_money']; ?>&nbsp;&nbsp;剩余：<?php echo $vo['tuition']-$vo['f_money']; ?></li>
                    </ul>
                    <ul class="weui-media-box__info">
                        <li class="weui-media-box__desc">日期：<?php echo $vo['f_date']; ?>&nbsp;&nbsp;票据号码：<?php echo $vo['f_date_num']; ?></li>
                    </ul>
                </div>
                <?php else: ?>
                <div class="weui-media-box weui-media-box_text">
                    <h4 class="weui-media-box__title"><?php echo $vo['university']; ?></h4>
                    <ul class="weui-media-box__info">
                        <li class="weui-media-box__desc">未查询到缴费信息</li>
                    </ul>
                </div>
                <?php endif; if($vo['s_money'] != null): ?>
                <div class="weui-media-box weui-media-box_text">
                    <ul class="weui-media-box__info">
                        <li class="weui-media-box__desc">结余：<?php echo $vo['tuition']-$vo['f_money']; ?>&nbsp;&nbsp;实收：<?php echo $vo['s_money']; ?>&nbsp;&nbsp;剩余：<?php echo $vo['tuition']-$vo['f_money']-$vo['s_money']; ?></li>
                    </ul>
                    <ul class="weui-media-box__info">
                        <li class="weui-media-box__desc">日期：<?php echo $vo['s_date']; ?>&nbsp;&nbsp;票据号码：<?php echo $vo['s_date_num']; ?></li>
                    </ul>
                </div>
                <?php endif; if($vo['t_money'] != null): ?>
                <div class="weui-media-box weui-media-box_text">
                    <ul class="weui-media-box__info">
                        <li class="weui-media-box__desc">结余：<?php echo $vo['tuition']-$vo['f_money']-$vo['s_money']; ?>&nbsp;&nbsp;实收：<?php echo $vo['t_money']; ?>&nbsp;&nbsp;剩余：<?php echo $vo['tuition']-$vo['f_money']-$vo['s_money']-$vo['t_money']; ?></li>
                    </ul>
                    <ul class="weui-media-box__info">
                        <li class="weui-media-box__desc">日期：<?php echo $vo['t_date']; ?>&nbsp;&nbsp;票据号码：<?php echo $vo['t_date_num']; ?></li>
                    </ul>
                </div>
                <?php endif; ?>
            </div>
